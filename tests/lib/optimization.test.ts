...
describe("removeComments", () => {
	it("should remove single-line comments", () => {
		expect(removeComments("color: black;")).toBe("color: black;");
	});
...
describe("getSidesShortcut", () => {
	it("margin if all side are different return 4 values single shortcut", () => {
		const marginRules =
			"margin-top: 12px; margin-right: 23px; margin-bottom: 11px; margin-left: 40px;";
	...
	it("margin if top and bottom are the same but not the left and right return 4 diffrent rules", () => {
		const marginRules =
			"margin-top: 12px; margin-right: 23px; margin-bottom: 12px; margin-left: 40px;";
	...
	it("padding if all side are different return 4 values single shortcut", () => {
		const paddingRules =
			"padding-top: 12px; padding-right: 23px; padding-bottom: 11px; padding-left: 40px;";
	...
	it("padding if top and bottom are the same but not the left and right return 4 diffrent rules", () => {
		const paddingRules =
			"padding-top: 12px; padding-right: 23px; padding-bottom: 12px; padding-left: 40px;";
	...
	it("should return one padding rules with all the sides different", () => {
		const paddingRules =
			"padding-bottom:3px;padding-left:4px;padding-right:2px;padding-top:1px";
	...
	it("should return the optimized rule and also do not affect other rules", () => {
		const paddingRules =
			"background-color:red;padding-top:10px;padding-bottom:10px;padding-right:10px;padding-left:30px;color:black;";
		const expected =
			"background-color:red;color:black;padding:10px 10px 10px 30px;";
		const res = createShorthandProperty(paddingRules, "padding");
		expect(res).toBe(expected);
	});
	...
	it("should return the optimized rule and also do not affect other rules while mixed with", () => {
		const paddingRules =
			"padding-top:10px;background-color:red;padding-bottom:10px;padding-right:10px;padding-left:30px;color:black;";
		const expected =
			"background-color:red;color:black;padding:10px 10px 10px 30px;";
		const res = createShorthandProperty(paddingRules, "padding");
		expect(res).toBe(expected);
	...
	it("should return expected side value", () => {
		...
		const top = getSideValue({
			rule: "padding",
			ruleValue: paddingRules,
			side: "top",
		});
...
describe("existsNullSides", () => {
	it("should return true if any side is null or undefined", () => {
		...
		expect(
			existsNullSides({ left: "10px", right: "10px", top: "", bottom: "10px" }),
		).toBe(true);
		expect(
			existsNullSides({
				left: undefined,
		...
		expect(
			existsNullSides({ left: "10px", right: "", top: "10px", bottom: "10px" }),
		).toBe(true);
	});
	it("should return false if all sides have values", () => {
		...
		expect(
			existsNullSides({ left: "0", right: "0", top: "0", bottom: "0" }),
		).toBe(false);
	});
